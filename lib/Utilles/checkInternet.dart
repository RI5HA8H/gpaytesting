  ...
  Future<bool> _onWillPop() async {
    return (await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: new Text('Do you want to exit an Yuva Sathi Application. If No then press No and please ON the Internet and enjoy the services automatic without exit application.',style: TextStyle(fontSize: 14,color: Colors.redAccent)),
        actions: <Widget>[
          TextButton(
